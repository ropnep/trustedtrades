...
const CONFIG = {
    ...
    MAX_API_CALLS: 10,  // Set your limit here (10 = safe test)
...
class LimitedTradieDiscovery {
    ...
    saveResults() {
        ...
        const filename = `limited-discovery-${new Date().toISOString().split('T')[0]}.json`;
        ...
        const summary = {
            ...
            max_calls_allowed: this.maxCalls,
            businesses_found: this.results.length,
